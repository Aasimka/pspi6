...
public class RaceSimulator extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Circle outerCircle = new Circle(250, 250, 200, Color.BLUEVIOLET);
        Circle middleCircle = new Circle(250, 250, 150, Color.YELLOW);
        Circle innerCircle = new Circle(250, 250, 100, Color.BLUE);
